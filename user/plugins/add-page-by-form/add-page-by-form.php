        ...
        switch (true) {
            case (in_array($action, $this->say_my_name)):
                ...
                if (isset($_POST)) {
                    ...
                    $page_frontmatter['process'] = array(
                      'markdown' => true,
                      'twig' => true
                    );
                    $page_frontmatter['never_cache_twig'] = true;
                        ...
                        */
                        if ($slug_field != '') {
                            ...
                            if (strpos($slug_field, ',') !== false) {
                                ...
                                //self::slug($page_frontmatter[$slug_field]);
                            }
                        }
                        if (!isset($slug)) {
                    ...
                    try {
                        ...
                        // load ajax function for send email button
                        $sendEmail = "
                        ...
                        $new_page->rawMarkdown((string) $content.$sendEmail);
